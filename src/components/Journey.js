        ...
        <section id="journey" className="md:min-h-screen py-20">
            ...
            <div className="container flex flex-col justify-center mx-auto mb-32 md:space-x-20 md:space-y-0 w-full md:flex-row">
                <div className="flex flex-col justify-start items-center space-y-10  md:w-1/2">
                    <div className="flex flex-col justify-center items-center md:space-x-20 mx-auto md:flex-row">
                        <img src={require("../img/fresnostate_400x400.png")} className="rounded-full w-1/2" />
                        <img src={require("../img/aws-certified-cloud-practitioner.png")} className="rounded-full w-1/2" />
                        <img src={require("../img/bitwise_400x400.jpg")} className="rounded-full w-1/2" />
