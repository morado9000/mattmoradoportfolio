    ...
    return (
        <>
            <section id="docs" className="md:min-h-screen py-20">
                ...
                <div className="container flex flex-col justify-center space-y-10 mb-32 mx-auto">
                    <div className="flex flex-col items-center mx-auto md:w-1/2">
                        <h2 className="text-4xl font-bold text-center">Resume</h2>
                        <a className="w-24 p-5 m-3 bg-black text-center text-white" href="Resume_2023_New.pdf" target="_blank">Go</a>
                    </div>
                    <div className="flex flex-col items-center mx-auto md:w-1/2">
