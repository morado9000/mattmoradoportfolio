    ...
    return (
        <>
            <section id="intro" className="py-20 md:min-h-screen">
                <h1 className="text-6xl mb-20 font-bold text-center" x-intersect="$el.classList.add('fadeInUp')">
                    Welcome
                </h1>
                <div className="container flex flex-col justify-items-center items-center px-6 mx-auto md:space-x-5 md:space-y-4">
                        ...
                        <div className="text-gray-600 text-center text-2xl md:w-1/2" x-intersect="$el.classList.add('fadeInUp')">
